...
- **Hedge isolation:** `positions.is_hedge INTEGER DEFAULT 0` (migration 48). Hedge positions (catastrophe BTC short) are excluded from MAX_CONCURRENT_POSITIONS, streak counters, consec-loss breaker.
